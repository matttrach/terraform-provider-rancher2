...
## [15.0.0](https://github.com/matttrach/terraform-provider-rancher2/compare/v15.0.0...v15.0.0) (2026-05-07)
...
* cluster proxy config ([#1683](https://github.com/matttrach/terraform-provider-rancher2/issues/1683)) ([e2a374a](https://github.com/matttrach/terraform-provider-rancher2/commit/e2a374a01ab451ec90c6fd41f646b833309a8185))
...
* support generic OIDC provider ([#1644](https://github.com/matttrach/terraform-provider-rancher2/issues/1644)) ([4417468](https://github.com/matttrach/terraform-provider-rancher2/commit/4417468b60abee4e969aa598564ed3d7bd3f4593))
...
* add automation for release issues and tests ([#1692](https://github.com/matttrach/terraform-provider-rancher2/issues/1692)) ([31d75e5](https://github.com/matttrach/terraform-provider-rancher2/commit/31d75e5180721e1a451c50e7c7e5ae3e3f274ef6))
* add common environment variables to workflow ([#1742](https://github.com/matttrach/terraform-provider-rancher2/issues/1742)) ([827540e](https://github.com/matttrach/terraform-provider-rancher2/commit/827540e7e95aafe97cbbd890e714d86acdbf06a1))
* add config for release-please ([#1730](https://github.com/matttrach/terraform-provider-rancher2/issues/1730)) ([575e79e](https://github.com/matttrach/terraform-provider-rancher2/commit/575e79e8c9f7ee5b032ba571c8ece6bbb481f265))
...
* add manual rc release and update permissions ([#1746](https://github.com/matttrach/terraform-provider-rancher2/issues/1746)) ([24537b0](https://github.com/matttrach/terraform-provider-rancher2/commit/24537b0fc7b986716d03d9b8771ad7c897b6e737))
...
* add support for data directories ([#1665](https://github.com/matttrach/terraform-provider-rancher2/issues/1665)) ([637dbb9](https://github.com/matttrach/terraform-provider-rancher2/commit/637dbb9755af488a279b7e72fb301c54d4bbf83d))
* adjust path and remove module context ([#1706](https://github.com/matttrach/terraform-provider-rancher2/issues/1706)) ([e2c9c08](https://github.com/matttrach/terraform-provider-rancher2/commit/e2c9c0822e377c28ee6bcd864bfdb947c9361b17))
...
* change from "main" to "tracking" ([#1712](https://github.com/matttrach/terraform-provider-rancher2/issues/1712)) ([35d9146](https://github.com/matttrach/terraform-provider-rancher2/commit/35d9146a4ba995654c08bec2e6a4c70686000cc9))
...
* do not use dot syntax in path ([#1705](https://github.com/matttrach/terraform-provider-rancher2/issues/1705)) ([5821942](https://github.com/matttrach/terraform-provider-rancher2/commit/5821942a237dd6f3c708fa21b3cf773e5b102df9))
* don't check user state on creation ([#1699](https://github.com/matttrach/terraform-provider-rancher2/issues/1699)) ([4ebecdb](https://github.com/matttrach/terraform-provider-rancher2/commit/4ebecdb4186a1676616da2fbcdfb29b1cfdca334))
* emit all response data for troubleshooting ([#1714](https://github.com/matttrach/terraform-provider-rancher2/issues/1714)) ([d8490c3](https://github.com/matttrach/terraform-provider-rancher2/commit/d8490c314b55ab63d0476a3ec74bc47012dd1bd2))
...
* export GitHub scripts and validate in CI ([#1702](https://github.com/matttrach/terraform-provider-rancher2/issues/1702)) ([4412d64](https://github.com/matttrach/terraform-provider-rancher2/commit/4412d64f6113bc3a1bcabd9dd4dbd1dcd572ec97))
* fix script paths ([#1704](https://github.com/matttrach/terraform-provider-rancher2/issues/1704)) ([0609f72](https://github.com/matttrach/terraform-provider-rancher2/commit/0609f72d82257a82c66f19133f969c6b5163ceba))
...
* force directory path ([#1710](https://github.com/matttrach/terraform-provider-rancher2/issues/1710)) ([305ea61](https://github.com/matttrach/terraform-provider-rancher2/commit/305ea616c608e710dec5db2fe8c0b22d38e54a38))
...
* improve registry documentation ([#1664](https://github.com/matttrach/terraform-provider-rancher2/issues/1664)) ([72bbd0c](https://github.com/matttrach/terraform-provider-rancher2/commit/72bbd0c8ff703749c1ad584abf43d3524ccd10dc))
...
* inconsistent plan with EKS template ([#1639](https://github.com/matttrach/terraform-provider-rancher2/issues/1639)) ([3140be6](https://github.com/matttrach/terraform-provider-rancher2/commit/3140be67a25605893373c53fa9fef6ec849f34ea))
...
* process imported config alone ([#1651](https://github.com/matttrach/terraform-provider-rancher2/issues/1651)) ([bc8d237](https://github.com/matttrach/terraform-provider-rancher2/commit/bc8d237f52edb1af8bbcfbb9a270c4d9ab2103eb))
* PSACT deletion hanging ([#1653](https://github.com/matttrach/terraform-provider-rancher2/issues/1653)) ([1bccd68](https://github.com/matttrach/terraform-provider-rancher2/commit/1bccd68900cd627fbe49545e15086ebe11fc601a))
...
* Update compatibility matrix ([#1617](https://github.com/matttrach/terraform-provider-rancher2/issues/1617)) ([1c0e84c](https://github.com/matttrach/terraform-provider-rancher2/commit/1c0e84c49974f199aa12991afb823368ac33a7a1))
...
* update pre-release to see new tag format ([#1623](https://github.com/matttrach/terraform-provider-rancher2/issues/1623)) ([bbbd78f](https://github.com/matttrach/terraform-provider-rancher2/commit/bbbd78f9463bd8019904d8bd91cf9899a4297640))
...
* use modern import logic ([#1708](https://github.com/matttrach/terraform-provider-rancher2/issues/1708)) ([1d0d125](https://github.com/matttrach/terraform-provider-rancher2/commit/1d0d125ca93bd783b1c9cec9245a7e70288bafe9))
