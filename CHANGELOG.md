...
## [15.0.0](https://github.com/matttrach/terraform-provider-rancher2/compare/v15.0.0...v15.0.0) (2026-08-29)


### ⚠ BREAKING CHANGES

* Add user principal id to global role binding ([#2252](https://github.com/matttrach/terraform-provider-rancher2/issues/2252))

### Features

* Add new field `extended` to resource quota handlers ([#1811](https://github.com/matttrach/terraform-provider-rancher2/issues/1811)) ([3f3da57](https://github.com/matttrach/terraform-provider-rancher2/commit/3f3da57a5168c6b697b125d4d364774e375a2794))
* add refresh_interval support to catalog_v2 ([#2202](https://github.com/matttrach/terraform-provider-rancher2/issues/2202)) ([e956610](https://github.com/matttrach/terraform-provider-rancher2/commit/e95661047788b48bfc6a05a92c8fb2a69def9a8a))
* add reserved memory field ([#1510](https://github.com/matttrach/terraform-provider-rancher2/issues/1510)) ([c1b4fa0](https://github.com/matttrach/terraform-provider-rancher2/commit/c1b4fa0bbb74f2a9be9616419ede917504e8e5e0))
* add s3 retention config for etcd snapshots ([#2402](https://github.com/matttrach/terraform-provider-rancher2/issues/2402)) ([1730d97](https://github.com/matttrach/terraform-provider-rancher2/commit/1730d977ad2c12d51830d4b1c0ba55776f1e1f9d))
* add skip_schema_validation to app_v2 ([#2294](https://github.com/matttrach/terraform-provider-rancher2/issues/2294)) ([#2298](https://github.com/matttrach/terraform-provider-rancher2/issues/2298)) ([b1f8bd7](https://github.com/matttrach/terraform-provider-rancher2/commit/b1f8bd7acce74cef20235ce9b2b4a29536f7d04f))
* add use internal certs option for local auth endpoint in cluster v2 ([#1626](https://github.com/matttrach/terraform-provider-rancher2/issues/1626)) ([#2301](https://github.com/matttrach/terraform-provider-rancher2/issues/2301)) ([3e1899c](https://github.com/matttrach/terraform-provider-rancher2/commit/3e1899c7bf2cdc687d224e8779a0b204bf835083))
* Add user principal id to global role binding ([#2252](https://github.com/matttrach/terraform-provider-rancher2/issues/2252)) ([84dc033](https://github.com/matttrach/terraform-provider-rancher2/commit/84dc033118ca29ff93f1d94dca095036bf2bd65a))
* added ipv6 suppport for eks operator ([#2005](https://github.com/matttrach/terraform-provider-rancher2/issues/2005)) ([e6f04c7](https://github.com/matttrach/terraform-provider-rancher2/commit/e6f04c7b0e4182b44f1222ee71c0117c22bcc0fb))
* Expose the OIDC Client secret. ([#2349](https://github.com/matttrach/terraform-provider-rancher2/issues/2349)) ([#2373](https://github.com/matttrach/terraform-provider-rancher2/issues/2373)) ([97a08e3](https://github.com/matttrach/terraform-provider-rancher2/commit/97a08e3a24e58686d29106012ed572a3f18efc36))
* GitHub app provider ([#1695](https://github.com/matttrach/terraform-provider-rancher2/issues/1695)) ([cf6e584](https://github.com/matttrach/terraform-provider-rancher2/commit/cf6e5849de63cee6acc859b7bebceb61d345ce15))
* implement PC and PDB support for the fleet agent ([#1986](https://github.com/matttrach/terraform-provider-rancher2/issues/1986)) ([ebf8d31](https://github.com/matttrach/terraform-provider-rancher2/commit/ebf8d31fd977a53aa40730f5a8c147f1d5145993))
* implement support to nutanix machine config ([#2083](https://github.com/matttrach/terraform-provider-rancher2/issues/2083)) ([a214fea](https://github.com/matttrach/terraform-provider-rancher2/commit/a214fea018afd20222a5ece6058af1b8a30e3a04))
* keycloak OIDC auth provider ([#2033](https://github.com/matttrach/terraform-provider-rancher2/issues/2033)) ([90d2e4e](https://github.com/matttrach/terraform-provider-rancher2/commit/90d2e4e1f5afd278ff8730120bae297af8e3de26))
* OIDC Client validation ([#2352](https://github.com/matttrach/terraform-provider-rancher2/issues/2352)) ([#2372](https://github.com/matttrach/terraform-provider-rancher2/issues/2372)) ([8d07bdd](https://github.com/matttrach/terraform-provider-rancher2/commit/8d07bdd3565d3538e2430b71e5c765ff81f5b7a2))
* Support OIDC Provider OIDC Clients ([#2147](https://github.com/matttrach/terraform-provider-rancher2/issues/2147)) ([#2270](https://github.com/matttrach/terraform-provider-rancher2/issues/2270)) ([fc9497f](https://github.com/matttrach/terraform-provider-rancher2/commit/fc9497f0a7b3ca93978880fa6e06f2cf41fb889c))
* Support Openstack Server Groups affinity ([#2223](https://github.com/matttrach/terraform-provider-rancher2/issues/2223)) ([fc9cf47](https://github.com/matttrach/terraform-provider-rancher2/commit/fc9cf47d8920284a8d6a8628bc2afb01e2dd80cf))


### Bug Fixes

* [Docs] Add inherited_cluster_roles to docs ([#1342](https://github.com/matttrach/terraform-provider-rancher2/issues/1342)) ([04d1088](https://github.com/matttrach/terraform-provider-rancher2/commit/04d10888eb9e360f01c45a1dd22a1409516e1207))
* add all protocols to metadata ([#1794](https://github.com/matttrach/terraform-provider-rancher2/issues/1794)) ([186d8f6](https://github.com/matttrach/terraform-provider-rancher2/commit/186d8f6643c43911ea7b9ad98bb72fb7e080a5c8))
* add FOSSA scanning workflow ([#1988](https://github.com/matttrach/terraform-provider-rancher2/issues/1988)) ([7c865b3](https://github.com/matttrach/terraform-provider-rancher2/commit/7c865b36803b553f3bb8586e60b90bbd15fb6f2c))
* add permissions to update issues ([#1936](https://github.com/matttrach/terraform-provider-rancher2/issues/1936)) ([a48759f](https://github.com/matttrach/terraform-provider-rancher2/commit/a48759f52e5c531d65b7a7ca2828c9d9ce87c504))
* add search option exact match in principal ([#1331](https://github.com/matttrach/terraform-provider-rancher2/issues/1331)) ([a3f15f1](https://github.com/matttrach/terraform-provider-rancher2/commit/a3f15f14cca0446676e0d499f119798ccbd686ec))
* add support for AuthConfig Cognito ([#2029](https://github.com/matttrach/terraform-provider-rancher2/issues/2029)) ([1f3fd79](https://github.com/matttrach/terraform-provider-rancher2/commit/1f3fd793f7f86c6c96f26170227a143426f5286c))
* Add the inherited-namespaced-rules field to globalroles ([#2340](https://github.com/matttrach/terraform-provider-rancher2/issues/2340)) ([#2417](https://github.com/matttrach/terraform-provider-rancher2/issues/2417)) ([7e8baeb](https://github.com/matttrach/terraform-provider-rancher2/commit/7e8baebdaca85ebd1cef64e43e5359eed861d725))
* allow specifying sha ([#1764](https://github.com/matttrach/terraform-provider-rancher2/issues/1764)) ([47e9f55](https://github.com/matttrach/terraform-provider-rancher2/commit/47e9f5598e6cfb25d6b0e80c745c8a30d2469d43))
* Backport 2208 to v15 ([#2213](https://github.com/matttrach/terraform-provider-rancher2/issues/2213)) ([296c351](https://github.com/matttrach/terraform-provider-rancher2/commit/296c3519cdcaafbecf633eef7667d3441c423967))
* Backport 2238 v15 ([#2247](https://github.com/matttrach/terraform-provider-rancher2/issues/2247)) ([7892188](https://github.com/matttrach/terraform-provider-rancher2/commit/7892188be8ee397ca5bad0effce98469f2ec2ffe))
* break out the config pkg for better testing ([#1899](https://github.com/matttrach/terraform-provider-rancher2/issues/1899)) ([80e2197](https://github.com/matttrach/terraform-provider-rancher2/commit/80e21977be85183cc89fdd86990a5fa8a207d31d))
* build before testing ([#1903](https://github.com/matttrach/terraform-provider-rancher2/issues/1903)) ([fed4427](https://github.com/matttrach/terraform-provider-rancher2/commit/fed442767443ca63b01fe5dde75183ed6a8f3526))
* Bump Go dependencies and Go version. ([#2278](https://github.com/matttrach/terraform-provider-rancher2/issues/2278)) ([#2286](https://github.com/matttrach/terraform-provider-rancher2/issues/2286)) ([3f4f3ad](https://github.com/matttrach/terraform-provider-rancher2/commit/3f4f3ada8f0036ff36c265e4d7e742f513ed4f23))
* Bump golang.org/x/crypto from 0.33.0 to 0.35.0 ([#1530](https://github.com/matttrach/terraform-provider-rancher2/issues/1530)) ([e617600](https://github.com/matttrach/terraform-provider-rancher2/commit/e617600293904004211c5f7f6adb2f3ec1130ee3))
* check out repository ([#1751](https://github.com/matttrach/terraform-provider-rancher2/issues/1751)) ([cdd8727](https://github.com/matttrach/terraform-provider-rancher2/commit/cdd8727a4d4994ef75e8f33b531ebae563e9e086))
* clean up nix install script ([#2230](https://github.com/matttrach/terraform-provider-rancher2/issues/2230)) ([#2235](https://github.com/matttrach/terraform-provider-rancher2/issues/2235)) ([70d4e05](https://github.com/matttrach/terraform-provider-rancher2/commit/70d4e0566cb46d39d2be10e2542712ab68d813f1))
* clear space on runner before release ([#1848](https://github.com/matttrach/terraform-provider-rancher2/issues/1848)) ([a5cb46c](https://github.com/matttrach/terraform-provider-rancher2/commit/a5cb46c3eb83fa790d927f6ee04095b2710a74da))
* clear space on runners before release tests ([#1838](https://github.com/matttrach/terraform-provider-rancher2/issues/1838)) ([e11d17d](https://github.com/matttrach/terraform-provider-rancher2/commit/e11d17dfaa85658bf589d815c2ee5a646f3586e0))
* Correct genericoidc provider implementation and tests ([#1691](https://github.com/matttrach/terraform-provider-rancher2/issues/1691)) ([0d7b485](https://github.com/matttrach/terraform-provider-rancher2/commit/0d7b485f4f5289a9c7f098e618b685731fd3985d))
* do not check out branch that we tag ([#1932](https://github.com/matttrach/terraform-provider-rancher2/issues/1932)) ([666f798](https://github.com/matttrach/terraform-provider-rancher2/commit/666f798b3eab0cddb2dfd0b723a10ed7ced53584))
* Docs Add name space variable to kubeconfig command ([#2226](https://github.com/matttrach/terraform-provider-rancher2/issues/2226)) ([222d5a8](https://github.com/matttrach/terraform-provider-rancher2/commit/222d5a8f5946711310253bc75acc018360da4099))
* enable manual rc release for older branches ([#1834](https://github.com/matttrach/terraform-provider-rancher2/issues/1834)) ([afc0a9f](https://github.com/matttrach/terraform-provider-rancher2/commit/afc0a9fd7118f9ba3b7c30c7d0b78817a0d2599b))
* ensure the correct workflow, users, and tags ([#1772](https://github.com/matttrach/terraform-provider-rancher2/issues/1772)) ([e28d375](https://github.com/matttrach/terraform-provider-rancher2/commit/e28d375ea4d4f5829cff4825d0844eef4a7e43c8))
* Fix removal of deployment configuration on imported clusters ([#2244](https://github.com/matttrach/terraform-provider-rancher2/issues/2244)) ([#2322](https://github.com/matttrach/terraform-provider-rancher2/issues/2322)) ([b4d4114](https://github.com/matttrach/terraform-provider-rancher2/commit/b4d41140c31f8a2fa403dff38c2db2eefefd384b))
* Fix typo in rancher2_cluster public_access_sources docs ([#2229](https://github.com/matttrach/terraform-provider-rancher2/issues/2229)) ([4865835](https://github.com/matttrach/terraform-provider-rancher2/commit/486583528661a93012addc3cd3d9ea3edb354275))
* for manual releases skip the git validation ([#1788](https://github.com/matttrach/terraform-provider-rancher2/issues/1788)) ([d67d532](https://github.com/matttrach/terraform-provider-rancher2/commit/d67d532439a371b71ee8e505c0bad72430e18cae))
* github script uses slashes for comments ([#1863](https://github.com/matttrach/terraform-provider-rancher2/issues/1863)) ([9a266f9](https://github.com/matttrach/terraform-provider-rancher2/commit/9a266f9edcec8a18b6a1b0870eedfff1366b8a6b))
* goreleaser needs git state at the new tag ([#1768](https://github.com/matttrach/terraform-provider-rancher2/issues/1768)) ([2d2805d](https://github.com/matttrach/terraform-provider-rancher2/commit/2d2805dfa68c48043795f38d1b2616f21cc378aa))
* improve cleanup and skip in CI ([#1895](https://github.com/matttrach/terraform-provider-rancher2/issues/1895)) ([8f5c657](https://github.com/matttrach/terraform-provider-rancher2/commit/8f5c657973c1d18f193809a6791e39a06bc2b334))
* improve test isolation logic ([#1879](https://github.com/matttrach/terraform-provider-rancher2/issues/1879)) ([188dae9](https://github.com/matttrach/terraform-provider-rancher2/commit/188dae9f0745cbe7609da762f47a1b4e480e6ae7))
* improve the documentation for cluster resources  ([#1805](https://github.com/matttrach/terraform-provider-rancher2/issues/1805)) ([d2f8ef4](https://github.com/matttrach/terraform-provider-rancher2/commit/d2f8ef4f65a7ff66eb83ce84020be4b11cdfcab0))
* login ([#2016](https://github.com/matttrach/terraform-provider-rancher2/issues/2016)) ([edb74ae](https://github.com/matttrach/terraform-provider-rancher2/commit/edb74ae0b807cbeb91b4da2ea059af8ed25d2d9d))
* make sure to only match the tag specified ([#1776](https://github.com/matttrach/terraform-provider-rancher2/issues/1776)) ([cb60c2a](https://github.com/matttrach/terraform-provider-rancher2/commit/cb60c2a78eaa0b44b1eb2d7d71356ec8b8c5b1d1))
* manual full release workflow ([#1759](https://github.com/matttrach/terraform-provider-rancher2/issues/1759)) ([73f3e9c](https://github.com/matttrach/terraform-provider-rancher2/commit/73f3e9c9f4e827310bba58f59dec59f103fe5be4))
* migrate login flow to /v1-public endpoint ([#1997](https://github.com/matttrach/terraform-provider-rancher2/issues/1997)) ([3523df3](https://github.com/matttrach/terraform-provider-rancher2/commit/3523df3ed8dceb1db465783a3170be6d1a1e0f33))
* missing quotes causing syntax error ([#1907](https://github.com/matttrach/terraform-provider-rancher2/issues/1907)) ([6bfbfd4](https://github.com/matttrach/terraform-provider-rancher2/commit/6bfbfd4fe6faee60c94f87cc9ffe288cc82c2591))
* need to quote json list ([#1875](https://github.com/matttrach/terraform-provider-rancher2/issues/1875)) ([565c318](https://github.com/matttrach/terraform-provider-rancher2/commit/565c3182b5e3d23231072a58b2e96afc4fa8d257))
* notifications to issues for manual rc ([#1923](https://github.com/matttrach/terraform-provider-rancher2/issues/1923)) ([d05989f](https://github.com/matttrach/terraform-provider-rancher2/commit/d05989fe7c0f4c791173c351768a0c92e185737a))
* prepare for v14 release ([#2012](https://github.com/matttrach/terraform-provider-rancher2/issues/2012)) ([d396219](https://github.com/matttrach/terraform-provider-rancher2/commit/d39621997494dbd17f0cd8b38fc8f4d03899d9c8))
* rc release calculator for new branches ([#2025](https://github.com/matttrach/terraform-provider-rancher2/issues/2025)) ([cfad809](https://github.com/matttrach/terraform-provider-rancher2/commit/cfad809bfda59b7ee8c6e7288b5280cb3550a5bd))
* release as v15.0.0 ([#2243](https://github.com/matttrach/terraform-provider-rancher2/issues/2243)) ([46ef025](https://github.com/matttrach/terraform-provider-rancher2/commit/46ef025446f5eb54d9d174c46f30de1518310341))
* remove broken resources ([#1693](https://github.com/matttrach/terraform-provider-rancher2/issues/1693)) ([2785ae4](https://github.com/matttrach/terraform-provider-rancher2/commit/2785ae4fc73abe826df791f7b02984dc8293ecf0))
* remove GKE enable logic ([#2000](https://github.com/matttrach/terraform-provider-rancher2/issues/2000)) ([0b9e382](https://github.com/matttrach/terraform-provider-rancher2/commit/0b9e382e29389c3996a43e346826bb9491f43d36))
* Remove ingress Nginx annotation examples ([#2038](https://github.com/matttrach/terraform-provider-rancher2/issues/2038)) ([610b2f5](https://github.com/matttrach/terraform-provider-rancher2/commit/610b2f56d3a6f4bd480e1605e5ff9275bfe18983))
* remove protected filter when getting branches in issue tracking workflow ([#2110](https://github.com/matttrach/terraform-provider-rancher2/issues/2110)) ([b115402](https://github.com/matttrach/terraform-provider-rancher2/commit/b1154021d93b9b5450c283859d5c4a8918dd2b26))
* remove pull target ([#2098](https://github.com/matttrach/terraform-provider-rancher2/issues/2098)) ([3def343](https://github.com/matttrach/terraform-provider-rancher2/commit/3def343e0c12e269b6fc1df2dcd6bd3acdc04b60))
* remove rke1 dependency ([#2289](https://github.com/matttrach/terraform-provider-rancher2/issues/2289)) ([#2297](https://github.com/matttrach/terraform-provider-rancher2/issues/2297)) ([415c7ab](https://github.com/matttrach/terraform-provider-rancher2/commit/415c7abeab854cdbf7612e7ac7a79a94f3b10d14))
* remove the default template ([#1780](https://github.com/matttrach/terraform-provider-rancher2/issues/1780)) ([acc669c](https://github.com/matttrach/terraform-provider-rancher2/commit/acc669cf0ad10c09d798d197d62aeb33ebc34208))
* repository owner is in github context ([#1891](https://github.com/matttrach/terraform-provider-rancher2/issues/1891)) ([b23d521](https://github.com/matttrach/terraform-provider-rancher2/commit/b23d521ee107dfebb9a04823a5d510e6d00a289a))
* resolve user_principal_id to user_id on global role binding create ([#2366](https://github.com/matttrach/terraform-provider-rancher2/issues/2366)) ([#2416](https://github.com/matttrach/terraform-provider-rancher2/issues/2416)) ([9434405](https://github.com/matttrach/terraform-provider-rancher2/commit/943440541b8e93e2489e3c503a21a82b9fc053d8))
* Revert "feat: support using internal certs for the local auth endpoint" ([#1626](https://github.com/matttrach/terraform-provider-rancher2/issues/1626)) ([#2440](https://github.com/matttrach/terraform-provider-rancher2/issues/2440)) ([#2445](https://github.com/matttrach/terraform-provider-rancher2/issues/2445)) ([c85328c](https://github.com/matttrach/terraform-provider-rancher2/commit/c85328cb765e5f15c63e345ed35ad2ab2431d1fb))
* run tests in different jobs ([#1859](https://github.com/matttrach/terraform-provider-rancher2/issues/1859)) ([651634a](https://github.com/matttrach/terraform-provider-rancher2/commit/651634a862d94779b02e0c2154a62a6cad47782d))
* security vulnerabilities and tracking workflow label ([#2130](https://github.com/matttrach/terraform-provider-rancher2/issues/2130)) ([4e5d376](https://github.com/matttrach/terraform-provider-rancher2/commit/4e5d3764d8702b1c66ddca1477ea1ba2691f3cf9))
* set bootstrap sha and release version ([#1755](https://github.com/matttrach/terraform-provider-rancher2/issues/1755)) ([54b7dcf](https://github.com/matttrach/terraform-provider-rancher2/commit/54b7dcf3dde80b52a1acaeef5c37b61a1547294b))
* set new release version ([#2021](https://github.com/matttrach/terraform-provider-rancher2/issues/2021)) ([b466f31](https://github.com/matttrach/terraform-provider-rancher2/commit/b466f31925f7b6d533e9e1ec8363646029d3df8a))
* short circuit the testing logic ([#1867](https://github.com/matttrach/terraform-provider-rancher2/issues/1867)) ([42a638d](https://github.com/matttrach/terraform-provider-rancher2/commit/42a638d5b012d17ff96ccadfb8b52900c034d57f))
* Stop data sources from generating kubeconfig tokens on every plan ([#2269](https://github.com/matttrach/terraform-provider-rancher2/issues/2269)) ([#2287](https://github.com/matttrach/terraform-provider-rancher2/issues/2287)) ([8f0c51c](https://github.com/matttrach/terraform-provider-rancher2/commit/8f0c51c5ec6becf84c18a64c313884658c24a4c1))
* support exceptions in diff suppression ([#1808](https://github.com/matttrach/terraform-provider-rancher2/issues/1808)) ([2bb8da1](https://github.com/matttrach/terraform-provider-rancher2/commit/2bb8da1a6bf3fb23ffb6feea549eeda9f4b1506c))
* the first job should never skip ([#1887](https://github.com/matttrach/terraform-provider-rancher2/issues/1887)) ([d6a3ea6](https://github.com/matttrach/terraform-provider-rancher2/commit/d6a3ea6de5b7b2200b1a86d4cc4ea9cc51a7ae8a))
* typo in repository context ([#1883](https://github.com/matttrach/terraform-provider-rancher2/issues/1883)) ([c5ed793](https://github.com/matttrach/terraform-provider-rancher2/commit/c5ed7931de2049f7b5af8eded61a851d0200a35d))
* typo in script name ([#1915](https://github.com/matttrach/terraform-provider-rancher2/issues/1915)) ([0257fdf](https://github.com/matttrach/terraform-provider-rancher2/commit/0257fdf267cba828ace0667569393a6bc0d9336a))
* typo in variable name ([#1911](https://github.com/matttrach/terraform-provider-rancher2/issues/1911)) ([694d6ee](https://github.com/matttrach/terraform-provider-rancher2/commit/694d6ee981c52546119d4c6e912932dd95a0c501))
* update checkout ([#1842](https://github.com/matttrach/terraform-provider-rancher2/issues/1842)) ([58979f1](https://github.com/matttrach/terraform-provider-rancher2/commit/58979f1c7cd321719497c83ed0a535738070854a))
* update default token TTL to match Rancher ([#2220](https://github.com/matttrach/terraform-provider-rancher2/issues/2220)) ([23d0c85](https://github.com/matttrach/terraform-provider-rancher2/commit/23d0c8523d63389894f8bc5e7729d1fff0d8385a))
* update docs on app_v2 import ([#2317](https://github.com/matttrach/terraform-provider-rancher2/issues/2317)) ([#2329](https://github.com/matttrach/terraform-provider-rancher2/issues/2329)) ([45f8156](https://github.com/matttrach/terraform-provider-rancher2/commit/45f815675ae75a34407eaec27c7017e5bba9be82))
* update machine selector config example ([#1976](https://github.com/matttrach/terraform-provider-rancher2/issues/1976)) ([bda0250](https://github.com/matttrach/terraform-provider-rancher2/commit/bda025005fc5ae18427d8a7081db0d235ef5c558))
* update rancher2 config map import command ([#1287](https://github.com/matttrach/terraform-provider-rancher2/issues/1287)) ([1061ac6](https://github.com/matttrach/terraform-provider-rancher2/commit/1061ac6a404a4dac078a815805e07e04c6fd726a))
* update release config to get proper version ([#1955](https://github.com/matttrach/terraform-provider-rancher2/issues/1955)) ([c2e8d4a](https://github.com/matttrach/terraform-provider-rancher2/commit/c2e8d4a5d6559076cb7e01a010377cd3fed14e76))
* update release manifest to force new version ([#1951](https://github.com/matttrach/terraform-provider-rancher2/issues/1951)) ([c878c36](https://github.com/matttrach/terraform-provider-rancher2/commit/c878c366a4b2a38dfc06854a5cc7df4a6021aae8))
* update release to 13.1.0 ([#1943](https://github.com/matttrach/terraform-provider-rancher2/issues/1943)) ([a9ca6e7](https://github.com/matttrach/terraform-provider-rancher2/commit/a9ca6e7f1fe55dfe8dd9470f1bb91783ba536efc))
* update release to 13.1.1 ([#1947](https://github.com/matttrach/terraform-provider-rancher2/issues/1947)) ([b4df9f1](https://github.com/matttrach/terraform-provider-rancher2/commit/b4df9f18173ad061a11bb2a23b2820533573e189))
* update release version ([#1968](https://github.com/matttrach/terraform-provider-rancher2/issues/1968)) ([687f1a8](https://github.com/matttrach/terraform-provider-rancher2/commit/687f1a814abac0b5feef7f3b108ed24dd36b6480))
* update versions in registry manifest ([#1963](https://github.com/matttrach/terraform-provider-rancher2/issues/1963)) ([e75639c](https://github.com/matttrach/terraform-provider-rancher2/commit/e75639cda6634091849d427105c9642ebbd18cba))
* use back tick instead of single quotes ([#1852](https://github.com/matttrach/terraform-provider-rancher2/issues/1852)) ([b449a29](https://github.com/matttrach/terraform-provider-rancher2/commit/b449a2950334b1455c9e4250be01761bca4a2051))
* use environment to pass data to the script ([#1919](https://github.com/matttrach/terraform-provider-rancher2/issues/1919)) ([0b62b72](https://github.com/matttrach/terraform-provider-rancher2/commit/0b62b72bde062cccfda622ab132c18415e4f858f))
* use proper outputs for validating test ([#1871](https://github.com/matttrach/terraform-provider-rancher2/issues/1871)) ([46c9209](https://github.com/matttrach/terraform-provider-rancher2/commit/46c920972bc20271b9cfe2ed2cfdb8dc7dd78f44))
* use separate goreleaser files for manual ([#1784](https://github.com/matttrach/terraform-provider-rancher2/issues/1784)) ([f9cc6bb](https://github.com/matttrach/terraform-provider-rancher2/commit/f9cc6bb04f3217ccdd4377636f11c80bcb5412b3))
* v3 public fallback logic ([#2081](https://github.com/matttrach/terraform-provider-rancher2/issues/2081)) ([f9c7a99](https://github.com/matttrach/terraform-provider-rancher2/commit/f9c7a9910f2adb7cecbec5c3b3268e4ba4e4713a))
